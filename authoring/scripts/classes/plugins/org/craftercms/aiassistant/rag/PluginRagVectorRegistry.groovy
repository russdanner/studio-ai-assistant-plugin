...
class PluginRagVectorRegistry {
  ...
  static String buildCorpusText() {
    ...
    appendSection(sb, 'OPENAI_AUTHORING_INSTRUCTIONS', ToolPrompts.getOPENAI_AUTHORING_INSTRUCTIONS())
    appendSection(sb, 'OPENAI_USER_MESSAGE_TOOLS_POLICY_PREFIX', ToolPrompts.getOPENAI_USER_MESSAGE_TOOLS_POLICY_PREFIX())
    appendSection(sb, 'OPENAI_CHAT_ONLY_SYSTEM', ToolPrompts.getOPENAI_CHAT_ONLY_SYSTEM())
    appendSection(sb, 'OPENAI_FORM_ENGINE_SUPPRESS_REPO_WRITES', ToolPrompts.getOPENAI_FORM_ENGINE_SUPPRESS_REPO_WRITES())
    appendSection(sb, 'XML_REPAIR_REMINDER_AFTER_BAD_READ', ToolPrompts.getXML_REPAIR_REMINDER_AFTER_BAD_READ())
    appendSection(sb, 'UPDATE_CONTENT', ToolPrompts.getUPDATE_CONTENT())
    appendSection(sb, 'UPDATE_CONTENT_FORM_ENGINE', ToolPrompts.getUPDATE_CONTENT_FORM_ENGINE())
    appendSection(sb, 'ANALYZE_TEMPLATE', ToolPrompts.getANALYZE_TEMPLATE())
    appendSection(sb, 'UPDATE_TEMPLATE', ToolPrompts.getUPDATE_TEMPLATE())
    appendSection(sb, 'UPDATE_TEMPLATE_FORM_ENGINE', ToolPrompts.getUPDATE_TEMPLATE_FORM_ENGINE())
    appendSection(sb, 'UPDATE_CONTENT_TYPE', ToolPrompts.getUPDATE_CONTENT_TYPE())
    appendSection(sb, 'UPDATE_CONTENT_TYPE_FORM_ENGINE', ToolPrompts.getUPDATE_CONTENT_TYPE_FORM_ENGINE())
    appendSection(sb, 'DESC_GET_CONTENT', ToolPrompts.getDESC_GET_CONTENT())
    appendSection(sb, 'DESC_LIST_CONTENT_TRANSLATION_SCOPE', ToolPrompts.getDESC_LIST_CONTENT_TRANSLATION_SCOPE())
    appendSection(sb, 'DESC_GET_CONTENT_TYPE_FORM_DEFINITION', ToolPrompts.getDESC_GET_CONTENT_TYPE_FORM_DEFINITION())
    appendSection(sb, 'DESC_WRITE_CONTENT', ToolPrompts.getDESC_WRITE_CONTENT())
    appendSection(sb, 'DESC_TRANSFORM_SUBGRAPH', ToolPrompts.getDESC_TRANSFORM_CONTENT_SUBGRAPH())
    sb.toString()
  }
